...
const BlockchainLogsTerminal = () => {
  ...
  const scrollToBottom1 = () => {
    logsEndRef1.current?.scrollIntoView();
  };

  // Function to scroll to the bottom for Org2
  const scrollToBottom2 = () => {
    logsEndRef2.current?.scrollIntoView();
  };
  ...
  useEffect(() => {
    fetchOrg1Logs();
    scrollToBottom1(); // Scroll to the bottom of logs
  }, []);

  // Fetch Org2 logs on component mount (only once)
  useEffect(() => {
    fetchOrg2Logs();
    scrollToBottom2(); // Scroll to the bottom of logs
  }, []);
