...
const Introduction = () => {
  return (
    <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <Title level={3}>1. Submit ESG Data</Title>
      <Paragraph>
      ...
      <Title level={3}>2. Audit ESG Data</Title>
      <Paragraph>
      ...
      <Title level={3}>3. Investor View</Title>
      <Paragraph>
